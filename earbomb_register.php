...
//        $mysqli->escape_string($_POST['twitter']),
//        $mysqli->escape_string($_POST['facebook']),
...
<div class="register-container">
    ...
    <form action="" name="form1" method="post" onsubmit="return checkForm()" id="msform">
        ...
        <!-- fieldsets -->
        <fieldset>
            <h2 class="fs-title">註冊成為耳娛我炸的會員</h2>
...
//            alert('請填入姓名');
        ...
        if(isPass){
            ...
            $.post('earbomb_register_api.php', $(document.form1).serialize(), function(data){
                   console.log(data);
                   my_alert.show();
                   if(data.success){
